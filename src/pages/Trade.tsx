...
const scanAds: ScanAd[] = [
  ...
  { 
    ...
    description: "CloudSync delivers enterprise-grade multi-cloud synchronization solutions that enable businesses to seamlessly manage data across different cloud platforms with real-time sync and advanced security features.",
    companyAge: "1 year",
    revenue: "Pre Revenue",
  ...
  { 
    ...
    description: "GreenTech is pioneering sustainable energy solutions to create a carbon-neutral future. Our innovative products harness renewable energy sources to provide clean, reliable power for homes and businesses.",
    companyAge: "4 years",
    revenue: "Revenue Generating",
  ...
  { 
    ...
    description: "FinNext is building the future of digital banking with a comprehensive infrastructure platform that enables next-generation financial services, mobile-first experiences, and seamless payment processing.",
  ...
  { 
    ...
    description: "EduTech Pro revolutionizes education through AI-powered personalized learning paths. Our platform adapts to each student's learning style, pace, and goals to deliver optimal educational outcomes.",
    companyAge: "3 years",
    revenue: "Revenue Generating",
  ...
  { 
    ...
    description: "HealthSync AI transforms healthcare delivery with intelligent patient management and care coordination. Our AI platform streamlines communication between patients, providers, and health systems for better outcomes.",
    companyAge: "2 years",
    revenue: "Revenue Generating",
  ...
  { 
    ...
    description: "LogiChain leverages blockchain technology to bring unprecedented transparency to supply chains. Our platform enables businesses to track products from origin to delivery, ensuring authenticity and ethical sourcing.",
    companyAge: "1 year",
    revenue: "Pre Revenue",
  ...
  { 
    ...
    description: "FoodTech Ventures is revolutionizing the food industry with innovative farm-to-table technology. Our platform connects local farmers with consumers, reducing waste and promoting sustainable, healthy eating.",
    companyAge: "5 years",
    revenue: "Revenue Generating",
...
const sellers = [
  { 
    ...
    companyName: "Airbound Pvt Ltd",
    companyTagline: "Revolutionizing logistics with AI-powered drone delivery solutions",
    description: "Airbound is pioneering the future of logistics with cutting-edge AI-powered autonomous drones for faster delivery.",
    revenue: "Revenue Generating",
    fundsRaised: "₹25,00,000",
    minRange: 15,
    maxRange: 40
  ...
  { 
    ...
    companyName: "Zlyft Autonomy Pvt Ltd",
    companyTagline: "Building next-gen autonomous vehicles for urban transportation",
    description: "Zlyft is at the forefront of autonomous vehicle technology, developing advanced self-driving systems.",
    revenue: "Pre Revenue",
    fundsRaised: "₹15,00,000",
    minRange: 10,
    maxRange: 35
  ...
  { 
    ...
    companyName: "TechFlow Solutions",
    companyTagline: "Streamlining enterprise workflows with intelligent automation",
    description: "TechFlow provides intelligent workflow automation tools that help enterprises optimize their operations.",
    revenue: "Revenue Generating",
    fundsRaised: "₹40,00,000",
    minRange: 20,
    maxRange: 50
  ...
  { 
    ...
    companyName: "CloudSync Systems",
    companyTagline: "Seamless multi-cloud data synchronization and management platform",
    description: "CloudSync delivers enterprise-grade multi-cloud synchronization solutions for seamless data management.",
    revenue: "Pre Revenue",
    fundsRaised: "₹10,00,000",
    minRange: 12,
    maxRange: 30
  ...
  { 
    ...
    companyName: "GreenTech Innovations",
    companyTagline: "Sustainable energy solutions for a carbon-neutral future",
    description: "GreenTech is pioneering sustainable energy solutions to create a carbon-neutral future.",
    revenue: "Revenue Generating",
    fundsRaised: "₹32,00,000",
    minRange: 18,
    maxRange: 45
