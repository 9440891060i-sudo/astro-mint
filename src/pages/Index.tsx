...
const mockStartups = [
  {
    ...
    description: "Drone rules 2021 eased up, Greenzones allowance, Drones are in a hype right now leading to 100s of companies but no one focusing on high rise buildings.",
    traction: "Mvp functional, EOI signed, 1200+ test flights",
    logo: "https://images.unsplash.com/photo-1473968512647-3e447244af8f?w=100&h=100&fit=crop",
    stage: "PRE REVENUE",
    age: "1yr",
    fundingRounds: 2,
    fundsRaised: "200,000$",
    currentInvestors: ["Y combinator", "a16z", "rokefeller"],
    isRaising: true,
  ...
  },
  {
    ...
    description: "Advanced flight management systems for commercial airlines. Our predictive maintenance AI has helped reduce aircraft downtime by 40% across 15 major carriers worldwide.",
    traction: "15 major carriers onboarded, 40% reduction in downtime",
  ...
  },
  {
    ...
    description: "Our deep learning platform analyzes medical imaging with 98% accuracy, helping radiologists detect early-stage diseases. Currently deployed in 50+ hospitals across North America.",
    traction: "Deployed in 50+ hospitals, 98% accuracy rate",
  ...
  },
  {
    ...
    description: "Solar-powered EV charging stations with smart grid integration. We've installed 200+ charging points and partnered with major retail chains to expand green charging accessibility.",
    traction: "200+ charging points installed, partnerships with major retail chains",
  ...
  },
  {
    ...
    description: "Blockchain-based traceability platform connecting farmers directly with restaurants. Reducing food waste by 35% while ensuring fair prices for growers and fresh produce for consumers.",
    traction: "35% reduction in food waste, 200+ farmers connected",
